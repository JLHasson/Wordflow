...
$where = "";
	if($_GET['select'] === "both"){
		...
		$where = "WHERE `review_referral` = '0' AND ";
	} else if($_GET['select'] === "all_referrals") {
		$where = "WHERE `review_referral` = '1' AND ";
	} else if($_GET['select'] === "1_1"){	
		$where = "WHERE `review_category` = '1' AND ";
	} else if($_GET['select'] === "1_2"){	
		$where = "WHERE `review_category` = '2' AND ";
	} else if($_GET['select'] === "1_3"){	
		$where = "WHERE `review_category` = '3' AND ";
	} else if($_GET['select'] === "1_4") {
		$where = "WHERE `review_category` = '4' AND ";
	} else if($_GET['select'] === "1_5"){	
		$where = "WHERE `review_category` = '5' AND ";		
	} else if($_GET['select'] === "1_6"){	
		$where = "WHERE `review_category` = '6' AND ";		
	} else if($_GET['select'] === "1_7"){	
		$where = "WHERE `review_category` = '7' AND ";		
	} else if($_GET['select'] === "1_8"){	
		$where = "WHERE `review_category` = '8' AND ";		
	} else if($_GET['select'] === "1_9"){	
		$where = "WHERE `review_category` = '9' AND ";		
	} else if($_GET['select'] === "1_10"){	
		$where = "WHERE `review_category` = '10' AND ";		
	} else if($_GET['select'] === "1_11"){	
		$where = "WHERE `review_category` = '11' AND ";		
	} else if($_GET['select'] === "1_12"){	
		$where = "WHERE `review_category` = '12' AND ";		
	} else if($_GET['select'] === "1_13"){	
		$where = "WHERE `review_category` = '13' AND ";		
	} else if($_GET['select'] === "1_14"){	
		$where = "WHERE `review_category` = '14' AND ";		
	} else if($_GET['select'] === "1_15"){	
		$where = "WHERE `review_category` = '15' AND ";		
	} else if($_GET['select'] === "1_16"){	
		$where = "WHERE `review_category` = '16' AND ";		
	} else if($_GET['select'] === "1_17"){	
		$where = "WHERE `review_category` = '17' AND ";		
	} else if($_GET['select'] === "1_18"){	
		$where = "WHERE `review_category` = '18' AND ";		
	} else if($_GET['select'] === "2_1"){	
		$where = "WHERE `referral_category` = '1' AND ";
	} else if($_GET['select'] === "2_2"){	
		$where = "WHERE `referral_category` = '2' AND ";
	} else if($_GET['select'] === "2_3"){	
		$where = "WHERE `referral_category` = '3' AND ";
	} else if($_GET['select'] === "2_4"){	
		$where = "WHERE `referral_category` = '4' AND ";
	} else if($_GET['select'] === "2_5"){	
		$where = "WHERE `referral_category` = '5' AND ";
	} else if($_GET['select'] === "2_6"){
		$where = "WHERE `referral_category` = '6' AND ";
	} else if($_GET['select'] === "2_7"){	
		$where = "WHERE `referral_category` = '7' AND ";
	} else if($_GET['select'] === "2_8"){	
		$where = "WHERE `referral_category` = '8' AND ";
	} else if($_GET['select'] === "2_9"){	
		$where = "WHERE `referral_category` = '9' AND ";
	} else if($_GET['select'] === "2_10"){	
		$where = "WHERE `referral_category` = '10' AND ";
	} else if($_GET['select'] === "2_11"){	
		$where = "WHERE `referral_category` = '11' AND ";
	} else if($_GET['select'] === "2_12"){	
		$where = "WHERE `referral_category` = '12' AND ";
	} else if($_GET['select'] === "2_13"){	
		$where = "WHERE `referral_category` = '13' AND ";
	} else if($_GET['select'] === "2_14"){	
		$where = "WHERE `referral_category` = '14' AND ";
	} else if($_GET['select'] === "2_15"){	
		$where = "WHERE `referral_category` = '15' AND ";
	} else if($_GET['select'] === "2_16"){	
		$where = "WHERE `referral_category` = '16' AND ";
	} else if($_GET['select'] === "2_17"){	
		$where = "WHERE `referral_category` = '17' AND ";
	} else if($_GET['select'] === "2_18"){	
		$where = "WHERE `referral_category` = '18' AND ";
	} else if($_GET['select'] === "2_19"){	
		$where = "WHERE `referral_category` = '19' AND ";
	}
	$lastpost = $_GET['lastPost'];
	


	$mysqlQuery = mysql_query('SELECT * FROM `reviews` '.$where.' `review_id` < "' . $_GET['lastPost'] . '" ORDER BY `review_id` DESC LIMIT 0, 5');
