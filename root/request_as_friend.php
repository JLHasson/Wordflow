...
include_once "mysql_server/connect_to_mysql.php"; // <<---- Connect to database here
...
if ($_POST["request"] == "requestFriendship") {
	...
	if ($numRows > 0) {
		echo '<img src="images/error.png" width="20" height="20" alt="Error" /> You have a Friend request pending for this member. Please be patient.';
        exit(); 
	}
	...
	if ($numRows > 0) {
		echo '<img src="images/error.png" width="20" height="20" alt="Error" /> This user has requested you as a Friend already! Check your Requests on your profile.';
        exit(); 
	}
	...
	echo '<img src="images/success.png" width="20" height="20" alt="Success" /> Friend request sent successfully. This member must approve the request.';
    exit(); 
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////                                                                    PART 2                                                               //////////////
...
if ($_POST["request"] == "removeFriendship") {
	...
	//
	/*$decryptedID = base64_decode($_SESSION['id']);
	$id_array = explode("p3h9xfn8sq03hs2234", $decryptedID);
	$mem1SessID = $id_array[1];
	if ($mem1SessID != $mem1) {
    	echo("Your session is not equal to the post of mem1");
    	exit();
	}
	I don't understand why the session variable isn't working correctly
	*/
