...
if (isset($_POST['email']) && $_POST['email'] != "") {
       ...
       if ($emailcheck == 0){
              ...
              $outputForUser = '<font color="#FF0000">There is no account with that info<br />
                ...
                $headers ="From: $adminEmail\n"; // $adminEmail is established in [ /connect_to_mysql.php ]
...
<table class="mainBodyTable" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
  <tr>
